...
export const LOAD_MORE_PEOPLE_ACTION = '[People] Load More People';
export const SET_PEOPLE_ACTION = '[People] Set People';
export const APPEND_PEOPLE_ACTION = '[People] Append People';
...
export class LoadMorePeopleAction implements Action {
  public readonly type = LOAD_MORE_PEOPLE_ACTION;
}

export class SetPeopleAction implements Action {
  public readonly type = SET_PEOPLE_ACTION;

  constructor(public payload: PeopleResponse | null) {}
}

export class AppendPeopleAction implements Action {
  public readonly type = APPEND_PEOPLE_ACTION;
